...
import com.sigat.springboot.app.view.pdf.ProfesionalPdfView;
import com.sigat.springboot.app.view.pdf.VinculacionPdfView;
...
public class MvcConfig implements WebMvcConfigurer {
	...
	// metodo que se encarga de guardar el Objeto Locale con nuestra
	// internacionalizacion("es", "ES").
	@Bean
	...
	// Interceptor que se encarga de enviar el nuevo lenguaje elejido y cambiarlo en
	// la pagina.
	@Bean
