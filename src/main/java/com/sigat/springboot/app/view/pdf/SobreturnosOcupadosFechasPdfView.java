...
@Component("sobreturnosOcupadosFechasPdfView")
public class SobreturnosOcupadosFechasPdfView extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		String nombreArchivo = "sobreturnosOcupados_" + fecha + ".pdf";
		...
		List<Sobreturno> sobreturnosocupadosfechas = (List<Sobreturno>) model.get("sobreturnosocupadosfechas");
		...
		String titulo = "Listado de Sobreturnos Ocupados";
		...
		// Recorrer el List<> de sobreturnos ocupados.
		for (int i = 0; i < sobreturnosocupadosfechas.size(); i++) {
			...
			// Formatear la fecha del Sobreturno *********************************			
			LocalDateTime dateSobreturno = item.getRangoFechaHora();
			DateTimeFormatter formatterFechaSobreturno = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm");
			String formattedFechaSobreturno = dateSobreturno.format(formatterFechaSobreturno);
			// *******************************************************************
			...
			PdfPCell celdaFechaTurno = new PdfPCell(new Phrase(formattedFechaSobreturno, smallFontRed));
